...
const firmTiers: Tier[] = [
  {
    name: "Free",
    tagline: "Free professional preview",
    price: "R0",
  ...
  {
    name: "Enterprise",
    tagline: "Large firms / corporates",
    price: "Custom",
    priceSuffix: "tailored to scope",
